...
\newcommand\ps@Standard{
  \renewcommand\@oddhead{\selectlanguage{english}\rmfamily\color{black} Forge VR Explorer\hfill }
...
\subsubsection[{File Uploading}]{\selectlanguage{english}\rmfamily\bfseries\color{black}
	The ability for the user to upload a CAD file of their choosing
}
\smallskip
\paragraph[Introduction/Purpose of this
feature]{\hangindent2pt \selectlanguage{english}\rmfamily\bfseries\color{black}
Introduction/Purpose }
{\selectlanguage{english}\color{black} \hangindent2pt
