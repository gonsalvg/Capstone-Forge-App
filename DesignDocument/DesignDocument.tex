...
\begin{figure}[ht]
	\includegraphics[scale=0.75]{viewerfromlist_360.png}
	\caption{Forge Viewer List View Interface}
\end{figure}

\begin{figure}[ht]
	\includegraphics[scale=0.70]{viewerwithupload_480.png}
...
\begin{figure}[ht]
	\includegraphics[scale=0.55]{localUpload.png}
...
\begin{figure}[ht]
	\includegraphics[scale=0.45]{nonLocalUpload.png}
