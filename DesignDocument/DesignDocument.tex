...
\begin{figure}[ht]
	\includegraphics[scale=0.35]{WebInterface.png}
...
\begin{figure}[ht]
	\includegraphics[scale=0.35]{localUpload.png}
...
\subsubsection{Design relationships}
\begin{itemize}
	\item[]\textbf{model derivative and veiwer relationship} converted files will be sent to the viewer api to be displayed on the website \ref{modelView}
\end{itemize}
